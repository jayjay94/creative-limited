...
<a href='products_cat.php?add_cart=$products_id'><button style='color:red;'>add to cart</button></a><br>
<br>
</div>
...
<a href='products_brand.php?add_cart=$products_id'><button style='color:red;'>add to cart</button></a><br>
<br>
</div>
